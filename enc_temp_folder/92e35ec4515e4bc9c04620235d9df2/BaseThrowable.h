...
UCLASS()
class PLAYABLEPORTFOLIO_API ABaseThrowable : public AActor
{
	GENERATED_BODY()
...
public:
	...
	AAxeThrowEntity* GetPlayerRef() { return PlayerRef; }
...
public:
	...
	void SetPlayerRef(AAxeThrowEntity* newPlayer) { PlayerRef = newPlayer; }
private:
